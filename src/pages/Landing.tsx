...
function HeroPhoneMockup() {
  return (
    <div style={{
      ...
      <div style={{ padding: '52px 24px 64px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 28 }}>
        <p style={{ fontSize: 13, color: '#9A9A9A', textAlign: 'center', lineHeight: 1.7, margin: 0 }}>
          그럴까봐.<br />아주 쉽게 시작해요
        </p>
        <div style={{
          ...
          <Mic size={26} strokeWidth={1.5} color="#1A1A1A" />
        </div>
      </div>
    </div>
  );
...
function FeatureCard({ tag, title, body }: {
  ...
  return (
    <div style={{ border: '2px solid #1A1A1A', borderRadius: 20, background: 'white', overflow: 'hidden' }}>
